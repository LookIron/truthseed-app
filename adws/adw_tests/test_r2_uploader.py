...
This will:
1. Upload public/icon.svg to R2
...
def test_r2_upload():
    ...
    # Find test file (adapted for Next.js structure)
    test_file = "public/icon.svg"
    ...
    object_key = f"adw/test/r2_upload_test_{timestamp}_icon.svg"
